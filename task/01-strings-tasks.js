...
function getRectangleString(width, height) {
    ...
    return toprow + middlerow.repeat(height - 2) + bottomrow;
    // throw new Error('Not implemented');
    /*var res = "";
...
function encodeToRot13(str) {
    const correctorder = 'abcdefghijklmnopqrstuvwxyzabcdefghijklmABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLM';
    return str.replace(/[a-zA-Z]/g, letter => correctorder[correctorder.indexOf(letter) + 13]);
    // throw new Error('Not implemented');
}
